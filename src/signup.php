...
<html>
 ...
 <body>
  <br />
  <div class="container">
   <h2 align="center">Set up your account</h2>
   <center>
   ...
   <div class="col-md-6" style="margin:0 auto; float:none;">
    <form method="post" >
     ...
     <div class="form-group">
      <label>Courses Registered In</label>
     </div>
     <select name="selectcourse[]" id="SelectForm" multiple>
        <option value = 'comp307'>COMP 307</option>
        <option value = 'comp322'>COMP 322</option>
     ...
     <div class="form-group" align="center">
      ...
      <input type="submit" name="return" class="btn btn-info" value="Return to Login Page" />
     </div>
    </form>
   </div>
  </div>
